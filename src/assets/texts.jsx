...
import carducci from './carducci.png'
import event from './77event.png'
import tankwar from './Tank-war.png'
import brickbreaker from './brickbreaker.png'
import infiniterunner from './Infinite runner.png'
...
export const list = [
    ...
    { link: '', img: tankwar },
    { link: '', img: brickbreaker },
    { link: 'https://drive.google.com/file/d/1QXjIrN4PmO0tN1eCeER8qEfJKvohT2Re/view?usp=drive_link', img: infiniterunner }
]
...
export const frTopLeftTxt = {
    title1: 'Matéo,',
    title2: `intégrateur web,`,
    title3: 'game développeur',
...
export const enTopLeftTxt = {
    title1: `Matéo, `,
    title2: `web integrator`,
    title3: 'game developer',
    subtitle1: `I've always been greatly interested in`,
    subtitle2: `the way things work`,
    txt1: `and the best way to do it is to make it yourself.`,
    txt21: `It might be a video game, an app, or even an intricate website`,
    txt22: ` I've always wanted to know how it worked.`,
}

export const frTopRightTxt = {
...
export const enTopRightTxt = {
    title1: `Starting july 2023, I've pursued `,
...
export const frBottomRightTxt = {
    title1: `Début juin 2024 je me suis lancé dans une`,
    title2: `nouvelle formation avec le Gaming campus`,
    subtitle1: `pour apprendre le développement de jeux vidéo`,
    subtitle2: `ainsi que quelques notions sur les bases de données.`,
    txt11: `J'ai pu apprendre à créer un jeu en 2D grâce à Love2D ou Monogame`,
    txt12: `de même que des jeux en 3D avec Unity ou Unreal Engine.`,
    txt21: `Je suis aussi capable de créer une base de données SQLite, de la`,
    txt22: `documenter et de créer des fonctions basiques pour une automatisation simple.`,
    txt3: `Je continue maintenant à apprendre de mon côté en créant de petits jeux pour m'entraîner.`
}

export const enBottomRightTxt = {
    title1: `At the beginning of June 2024 I started`,
    title2: `in a new training with Gaming campus`,
    subtitle1: `to learn video game development`,
    subtitle2: `and some notions about databases.`,
    txt11: `I was taught how to create a 2D game thanks to Love2D or Monogame`,
    txt12: `as well as 3D games with Unity or Unreal Engine.`,
    txt21: `I am also able to create a SQLite database,`,
    txt22: `to document and create basic functions for simple automation.`,
    txt3: `I now continue to learn by myself by creating little games to train.`
}
